module Fayde.Controls {
    ...
    */
    ...
    export module arrays {
         ...
         */
        export function indexOf<T>(array: T[], item: T, equalsFunction?: Fayde.Controls.IEqualsFunction<T>): number {
         ...
         * within the specified array or -1 if not found.
         */
        export function lastIndexOf<T>(array: T[], item: T, equalsFunction?: Fayde.Controls.IEqualsFunction<T>): number {
            var equals = equalsFunction || Fayde.Controls.defaultEquals;
            var length = array.length;
         ...
         */
        export function contains<T>(array: T[], item: T, equalsFunction?: Fayde.Controls.IEqualsFunction<T>): boolean {
         ...
         */
        export function remove<T>(array: T[], item: T, equalsFunction?: Fayde.Controls.IEqualsFunction<T>): boolean {
         ...
         */
        export function frequency<T>(array: T[], item: T, equalsFunction?: Fayde.Controls.IEqualsFunction<T>): number {
            var equals = equalsFunction || Fayde.Controls.defaultEquals;
            var length = array.length;
            var freq = 0;
            for (var i = 0; i < length; i++) {
         ...
         */
        export function equals<T>(array1: T[], array2: T[], equalsFunction?: Fayde.Controls.IEqualsFunction<T>): boolean {
            var equals = equalsFunction || Fayde.Controls.defaultEquals;
    ...
    export class Dictionary<K, V>{
        ...
        * @this {Fayde.Controls.Dictionary}
        */
        clear() {
            this.table = {};
            this.nElements = 0;
    ...
    export class LinkedDictionary<K, V> extends Dictionary<K, V> {
        ...
        * @this {Fayde.Controls.LinkedDictionary}
        */
        clear() {
            super.clear();
            this.head.next = this.tail;
    ...
    //  * @param {Fayde.Controls.Dictionary} other the other dictionary.
    //  * @param {function(Object,Object):boolean=} valuesEqualFunction optional
    //  * function used to check if two values are equal.
    //  * @return {boolean} true if this dictionary is equal to the given dictionary.
    //  */
    // Fayde.Controls.Dictionary.prototype.equals = function(other,valuesEqualFunction) {
    // 	var eqF = valuesEqualFunction || Fayde.Controls.defaultEquals;
    // 	if(!(other instanceof Fayde.Controls.Dictionary)){
    // 		return false;
    // 	}
    // 	if(this.size() !== other.size()){
    // 		return false;
    ...
    export class Stack<T> {
         ...
         * @type Fayde.Controls.LinkedList
         * @private
         */
    ...
    export class PriorityQueue<T> {
         ...
         */
        constructor(compareFunction?: ICompareFunction<T>) {
            this.heap = new Heap<T>(Fayde.Controls.reverseCompareFunction(compareFunction));
        }
    ...
    export class Set<T>{
         ...
         * @param {Fayde.Controls.Set} otherSet other set.
         */
    ...
    export class Bag<T>{
        ...
        */
         ...
         * @return {Fayde.Controls.Set<T>} a set of unique elements in this bag.
         */
        toSet(): Set<T> {
